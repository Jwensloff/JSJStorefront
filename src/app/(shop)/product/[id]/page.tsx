    ...
    <div className="lg:flex  gap-40 m-10 w-fit">
      ...
      <div className="flex-col space-y-10 w-auto">
        ...
        <div className='space-x-5'>
          ...
          <Button size='lg' color='blue' placeholder={undefined}>Add To Cart</Button>
          </a>
          <a >
          <Button size='lg' color='gray' variant='outlined'  placeholder={undefined}>Continue Shopping</Button>
          </a>
        </div>
        <ul>
